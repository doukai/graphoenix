...
public class UserTest2Expression {
  ...
  private Collection<null.dto.inputObjectType.UserTest2Expression> exs;
  ...
  public Collection<null.dto.inputObjectType.UserTest2Expression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<null.dto.inputObjectType.UserTest2Expression> exs) {
    this.exs = exs;
  }
}
