...
public class UserRoleExpression {
  ...
  private Collection<null.dto.inputObjectType.UserRoleExpression> exs;
  ...
  public Collection<null.dto.inputObjectType.UserRoleExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<null.dto.inputObjectType.UserRoleExpression> exs) {
    this.exs = exs;
  }
}
