...
@Ignore
public class RoleRoleTypeListMutationTypeArguments implements MetaInput {
  private String id;
  ...
  private Collection<RoleRoleTypeInput> list;
  ...
  public Collection<RoleRoleTypeInput> getList() {
    return this.list;
  }

  public void setList(Collection<RoleRoleTypeInput> list) {
    this.list = list;
  }
