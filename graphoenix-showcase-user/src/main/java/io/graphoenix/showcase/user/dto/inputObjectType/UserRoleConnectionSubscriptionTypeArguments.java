...
@Ignore
public class UserRoleConnectionSubscriptionTypeArguments implements MetaExpression {
  ...
  private UserRoleOrderBy orderBy;
  ...
  public UserRoleOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(UserRoleOrderBy orderBy) {
