...
@Ignore
public class MerchantDirectorConnectionSubscriptionTypeArguments implements MetaExpression {
  ...
  private MerchantDirectorOrderBy orderBy;
  ...
  public MerchantDirectorOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(MerchantDirectorOrderBy orderBy) {
  ...
  public Collection<MerchantDirectorExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<MerchantDirectorExpression> exs) {
    this.exs = exs;
  }
