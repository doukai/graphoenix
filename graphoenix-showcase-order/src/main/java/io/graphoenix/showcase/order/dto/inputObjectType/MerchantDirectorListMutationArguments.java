...
@Ignore
public class MerchantDirectorListMutationArguments implements MetaInput {
  private String id;
  ...
  public Collection<MerchantDirectorInput> getList() {
    return this.list;
  }

  public void setList(Collection<MerchantDirectorInput> list) {
    this.list = list;
  }
