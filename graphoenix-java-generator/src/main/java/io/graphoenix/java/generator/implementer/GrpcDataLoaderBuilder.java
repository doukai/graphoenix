...
@ApplicationScoped
public class GrpcDataLoaderBuilder {
    ...
    @Inject
    public GrpcDataLoaderBuilder(IGraphQLDocumentManager manager, TypeManager typeManager) {
        this.manager = manager;
        this.typeManager = typeManager;
    }

    public GrpcDataLoaderBuilder setConfiguration(GraphQLConfig graphQLConfig) {
