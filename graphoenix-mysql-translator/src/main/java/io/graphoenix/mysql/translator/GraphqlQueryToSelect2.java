...
public class GraphqlQueryToSelect2 {

    private final GraphqlAntlrManager manager;
    private final GraphqlArgumentsToWhere argumentsToWhere;

    public GraphqlQueryToSelect2(GraphqlAntlrManager manager, GraphqlArgumentsToWhere argumentsToWhere) {
    ...
    protected Select objectSelectionToSelect(String typeName, List<GraphqlParser.SelectionContext> selectionContextList) {
    ...
    protected SubSelect objectSelectionToSubSelect(String parentTypeName, String typeName, GraphqlParser.FieldDefinitionContext fieldDefinitionContext, GraphqlParser.SelectionContext selectionContext) {
        ...
        if (selectionContext.field().arguments() != null) {
            Expression where = argumentsToWhere.argumentsToMultipleExpression(fieldDefinitionContext.type(), fieldDefinitionContext.argumentsDefinition(), selectionContext.field().arguments());
            if (where != null) {
                if (plainSelect.getWhere() != null) {
                    plainSelect.setWhere(new MultiAndExpression(Arrays.asList(plainSelect.getWhere(), where)));
                } else {
